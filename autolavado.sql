...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-03-2022 a las 06:02:36
...
(1, 'Cesar', 'Ramirez ', 'Cuevas', 'Vicente Suarez 110', '7641196033', 'cramirecu7@gmail.com', '2022-03-23', 1, NULL, NULL);
...
(23, '2022_03_11_184301_create_trabajadores_table', 1),
(24, '2022_03_11_184326_create_clientes_table', 1),
(25, '2022_03_11_184346_create_vehiculos_table', 1),
(26, '2022_03_11_184410_create_servicios_table', 1),
(27, '2022_03_11_184428_create_ventas_table', 1);
...
(1, 'Se planea que se le realice el cambio de aceite y un lavado de chasis ', 350, 1, '2022-03-27', NULL, NULL);
...
(1, 'Carlos', 'Martinez', 'Ortega', 'Allende 158', '7641103280', 'carlos@gmail.com', 'Cajero', 1, 'Carlos1234', NULL, NULL),
(2, 'Mauricio', 'Cruz', 'Maldonado', 'Ojo de Agua', '7651293123', 'Mau@gmail.com', 'Lavador', 1, 'Mau112345', NULL, NULL);
...
(1, 'cesar', 'cramirezcu7@gmail.com', NULL, '$2y$10$XQH/T7xPHaHQjFCSYcAyDeD0vlKgXgX7eOmezZbDoUc2B55L75Ocm', NULL, '2022-03-26 10:25:34', '2022-03-26 10:25:34');
...
(1, '190378', 'Mediano', 'vw', 1993, 'Rojo', 2, 1, 1, '2022-03-11', NULL, NULL);
...
(1, '2022-03-19', 1, 1, 1, 1, '2022-03-28 04:51:59', NULL);
...
--
ALTER TABLE `ventas`
  MODIFY `id_ventas` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
